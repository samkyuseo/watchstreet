...
import { getTotalValue, getUserLists, getUserWatches } from '../../api/lib/user';
import { IUserWatch, IUserList, IPriceData, IWatchList, IWatchArticle } from '../../../../types';
...
const ProfilePage = () => {
  ...
  const [trendingLists, setTrendingLists] = useState<IWatchList[] | undefined>(undefined);
