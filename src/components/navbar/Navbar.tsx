            ...
            <Container display="flex" maxWidth="90%" paddingY="10px">
                ...
                <HStack flex="4">
                    <InputGroup>
                        ...
                        <Input variant="outline" placeholder="Search watches" maxWidth="80%" focusBorderColor="gray"/>
                    </InputGroup>
                </HStack>
                <HStack flex="4" justifyContent="right">    
                    <Text mx="20px" variant="bold">Collection</Text>
                    <Text mx="20px" variant="bold">Account</Text>
                </HStack>
            </Container>
        </Box>
    )
